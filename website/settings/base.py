...
INSTALLED_APPS = [
    ...
    'pattern_library',
    'website.project_styleguide.apps.ProjectStyleguideConfig',
]
...
if 'SENTRY_DSN' in env:
    ...
    # dokku config:set website SENTRY_ENVIRONMENT=staging
...
if env.get('BASIC_AUTH_ENABLED', 'false').lower().strip() == 'true':
    ...
    BASIC_AUTH_LOGIN = env.get('BASIC_AUTH_LOGIN', 'website')
