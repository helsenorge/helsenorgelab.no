"""
Django settings for norwegian_ehealth project.
"""
import os
import sys
...
INSTALLED_APPS = [
    ...
    'norwegian_ehealth.news',
    'norwegian_ehealth.people',
    'norwegian_ehealth.search',
    'norwegian_ehealth.standardpages',
    'norwegian_ehealth.utils',
    ...
    'pattern_library',
    'norwegian_ehealth.project_styleguide.apps.ProjectStyleguideConfig',
]
...
ROOT_URLCONF = 'norwegian_ehealth.urls'
...
TEMPLATES = [
    {
        ...
        'OPTIONS': {
            'context_processors': [
                ...
                'norwegian_ehealth.utils.context_processors.global_vars',
            ],
...
WSGI_APPLICATION = 'norwegian_ehealth.wsgi.application'
...
if 'SENTRY_DSN' in env:
    ...
    # dokku config:set norwegian_ehealth SENTRY_ENVIRONMENT=staging
...
if env.get('BASIC_AUTH_ENABLED', 'false').lower().strip() == 'true':
    ...
    BASIC_AUTH_LOGIN = env.get('BASIC_AUTH_LOGIN', 'norwegian_ehealth')
    BASIC_AUTH_PASSWORD = env.get('BASIC_AUTH_PASSWORD', 'showmenor')
...
WAGTAIL_SITE_NAME = "norwegian_ehealth"
...
DEFAULT_PER_PAGE = 3  # TODO bump back up to 10
