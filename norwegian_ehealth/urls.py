...
from norwegian_ehealth.search import views as search_views
from norwegian_ehealth.utils.cache import get_default_cache_control_decorator
from norwegian_ehealth.utils.views import favicon, robots
...
# Error handlers
handler404 = 'norwegian_ehealth.utils.views.page_not_found'
handler500 = 'norwegian_ehealth.utils.views.server_error'
